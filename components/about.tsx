          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-zinc-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-zinc-400">
                I am a passionate software developer with over 5 years of
                experience in the industry. I specialize in front-end
                development and have a keen interest in user interface design. I
                love solving complex problems and creating intuitive, beautiful
